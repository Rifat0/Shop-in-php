            ...
            <section>
                ...
                <div class="main-slider-wrapper">
                    <div class="main-slider owl-carousel owl-carousel-inset">
                        ...
                        <div class="main-slider-item">
                            <div class="main-slider-image">
                                <img src="img/samples/sliders/4.jpg" alt="">
                            </div>
                                ...
                                <div class="fp-table">
                                    <div class="fp-table-cell center">
                                        <div class="container">
                                            ...
                                            <h2 class="small">Look Book<br>fashion 2016</h2>
                                ...
                                <div class="awe-media">
                                    <div class="awe-media-image">
                                        <a href="" title="New Collection For Man">
                                            <img src="img/samples/collections/trending/1.jpg" alt="">
                                        </a>
                                    </div>
                                    <!-- /.awe-media-image -->
                                ...
                                <div class="awe-media">
                                    <div class="awe-media-image">
                                        <a href="" title="New Trending Shop">
                                            <img src="img/samples/collections/trending/2.jpg" alt="">
                                        </a>
                                    </div>
                                    <!-- /.awe-media-image -->
                                ...
                                <div class="awe-media">
                                    <div class="awe-media-image">
                                        <a href="" title="New Fashion for Cafe Racer Boy">
                                            <img src="img/samples/collections/trending/3.jpg" alt="">
                                        </a>
                                    </div>
                                    <!-- /.awe-media-image -->
                                ...
                                <div class="awe-media">
                                    <div class="awe-media-image">
                                        <a href="" title="New Watch Style">
                                            <img src="img/samples/collections/trending/4.jpg" alt="">
                                        </a>
                                    </div>
                                    <!-- /.awe-media-image -->
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-6">
                                    <div class="cate-section-gutter">
                                        ...
                                        <div class="category-text">
                                            ...
                                            <a href="p_category.php" title="" class="btn btn-dark btn-outline">VIEW ALL</a>
                                        </div>
                                    </div>
                                    <!-- /.cate-section-gutter -->
                                </div>
                                        ...
                                        <div class="product-media">
                                            <div class="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/index/featured/1.jpg" alt="" class="current">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <div class="product product-grid">
                                        <div class="product-media">
                                            <div class="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/index/featured/2.jpg" alt="" class="current">
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt="">
                                                </a>
                                            </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <div class="product product-grid">
                                        <div class="product-media">
                                            <div class="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/index/featured/3.jpg" alt="" class="current">
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt="">
                                                </a>
                                            </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <div class="product product-grid">
                                        <div class="product-media">
                                            <div class="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/index/featured/4.jpg" alt="" class="current">
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt="">
                                                </a>
                                            </div>
                        ...
                        <div class="section-content">
                            <div class="home-section-posts owl-carousel">
                                ...
                                <div class="section-post">
                                    <div class="section-post-media">
                                        <a href="#" title="San Francisco Felt Pennant">
                                            <img src="img/samples/posts/index/1.jpg" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="section-post">
                                    <div class="section-post-media">
                                        <a href="#" title="San Francisco Felt Pennant">
                                            <img src="img/samples/posts/index/2.jpg" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="subscribe-comment">
                                        <p>Sign up to Text’s monthly newsletter for readers</p>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <form method="GET" action="sub.php" class="subscible-form">
                                        <div class="form-group">
                                            <label class="sr-only" for="subscribe-email">Email</label>
                                            <input name="email" type="email" placeholder="Enter your email address" class="form-control" id="subscribe-email">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="awe-media margin-bottom-20">
                                <div class="awe-media-image">
                                    <a href="p_category.php">
                                        <img src="img/samples/banners/home/home-banner-1.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- /.awe-media -->
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="awe-media margin-bottom-20">
                                <div class="awe-media-image">
                                    <a href="p_category.php">
                                        <img src="img/samples/banners/home/home-banner-2.png" alt="">
                                    </a>
                                </div>
                                <!-- /.awe-media -->
                            </div>
